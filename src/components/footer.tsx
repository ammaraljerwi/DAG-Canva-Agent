...
import { RemainingCredits, AuthorizeButton } from "src/components";
...
export const Footer = () => {
  ...
  return (
    <Rows spacing="1u">
      {!isAuthorized && <AuthorizeButton />}
      {!isRootRoute && <Button variant="secondary" onClick={reset} loading={loadingApp} stretch={true}> Log Out </Button>}
    </Rows>
  )
